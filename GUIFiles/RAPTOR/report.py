...
def htmlReport(groups: dict):
    ...
    for key in groups:
        ...
        info += """
                         <h2 class="u-align-left u-subtitle u-text u-text-custom-color-1 u-text-default u-text-11">Software</h2>"""
        software = apt.getSofwareByGroup(relationships_df, key)
        for i in range(len(software)):
            info += """<p class="u-align-left u-text u-text-custom-color-1 u-text-12">{}</p>
                        <details>
        ...
        info += """
                     <h2 class="u-align-left u-subtitle u-text u-text-custom-color-1 u-text-default u-text-11">Techniques</h2>"""
