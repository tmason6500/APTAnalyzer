...
index += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-2">80% - 89%</h2>'''
...
index += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-3">70% - 79%</h2>'''
...
index += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-4">60% - 69%</h2>'''
...
index += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-5">50% - 59%</h2>'''
...
home += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-2">80% - 89%</h2>'''
for i in range(len(eight)):
...
home += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-3">70% - 79%</h2>'''
for i in range(len(seven)):
...
home += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-4">60% - 69%</h2>'''
for i in range(len(six)):
...
home += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-5">50% - 59%</h2>'''
for i in range(len(five)):
...
if DEBUG:  
    webbrowser.open('Home.html', new=2)
...
if DEBUG:        
    webbrowser.open('About.html', new=2)
...
for key in groups:
    ...
    info += """
        <link rel="stylesheet" href="nicepage.css" media="screen">
    <link rel="stylesheet" href="group-Info.css" media="screen">
        <script class="u-script" type="text/javascript" src="jquery.js" defer=""></script>
        <script class="u-script" type="text/javascript" src="nicepage.js" defer=""></script>
        <meta name="generator" content="Nicepage 4.8.2, nicepage.com">
        <link id="u-theme-google-font" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i|Open+Sans:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i">
    ...
    info += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-2">80% - 89%</h2>'''
    for i in range(len(eight)):
    ...
    info += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-3">70% - 79%</h2>'''
    for i in range(len(seven)):
    ...
    info += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-4">60% - 69%</h2>'''
    for i in range(len(six)):
    ...
    info += '''<h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-5">50% - 59%</h2>'''
    for i in range(len(five)):
    ...
    # Edit the below to pull group data and populate
    info += """
                  </div>
                </div>
    ...
    info += """
                    <h1 class="u-align-center u-text u-text-custom-color-1 u-title u-text-6">{} - {}% Match</h1>""".format(apt.getData(groups_df, key, 'name'), groups.get(key))

    info += """
                    <h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-default u-text-7">Description</h2>
                    <p class="u-align-center u-text u-text-custom-color-1 u-text-default u-text-8">{}</p>""".format(apt.getData(groups_df, key, 'description'))

    info += """
                    <h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-default u-text-9">Associated Groups<br></h2>
                    <p class="u-align-center u-text u-text-custom-color-1 u-text-default u-text-10">{}</p>""".format(apt.getData(groups_df, key, 'associated groups'))
    ## Needs tactics added in
    info += """
                    <h2 class="u-align-center u-subtitle u-text u-text-custom-color-1 u-text-default u-text-11">Tactics/Techniques</h2>
                    <p class="u-align-center u-text u-text-custom-color-1 u-text-12">{}</p>"""
